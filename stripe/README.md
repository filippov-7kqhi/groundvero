# Payments and the Worker: GroundVero

## How groundvero.shop takes payment
...
`GET /stats` returns them, stored in the KV namespace `groundvero-EVENTS`.

- Worker: `https://groundvero-collector.stellapark1141.workers.dev`
...
needed: without it the script refuses a key whose account name is not GroundVero.
...
& {
  ...
  Set-Location "C:\Users\Hp\uk-stores\groundvero\stripe"
...
- delete the KV namespace `groundvero-EVENTS`. It holds the dashboard's data.
