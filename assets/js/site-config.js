/* ---------------------------------------------------------------------------
   Runtime configuration for GroundVero. Edited through /admin.html, or by hand.
...
window.SITE_CONFIG = {
  ...
  business: {
    ...
    companyNo: "",
    vatNo:     "",
    street:    "3 Palma Avenue, Airport",
    city:      "Manchester",
    postcode:  "",
    phone:     "+44 161 388 5211"
  },
  ...
  analyticsEndpoint: "https://groundvero-collector.stellapark1141.workers.dev",

  // Optional: Checkout Sessions for baskets with more than one machine.
  checkoutEndpoint: "https://groundvero-collector.stellapark1141.workers.dev/checkout",
